...
#ifdef H3LIB_EXPORTS
#define H3LIBRARY_API __declspec(dllexport) 
#else
#define H3LIBRARY_API __declspec(dllimport)
#endif
 ...
 */
H3Index H3LIBRARY_API H3_EXPORT(geoToH3)(const GeoCoord *g, int res);
/** @} */
...
void H3LIBRARY_API H3_EXPORT(h3ToGeo)(H3Index h3, GeoCoord *g);
/** @} */
...
void H3LIBRARY_API H3_EXPORT(h3ToGeoBoundary)(H3Index h3, GeoBoundary *gp);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(maxKringSize)(int k);

/** @brief hexagons neighbors in all directions, assuming no pentagons */
int H3LIBRARY_API H3_EXPORT(hexRange)(H3Index origin, int k, H3Index *out);
/** @} */

/** @brief hexagons neighbors in all directions, assuming no pentagons,
 * reporting
 * distance from origin */
int H3LIBRARY_API H3_EXPORT(hexRangeDistances)(H3Index origin, int k, H3Index *out,
                                 int *distances);

/** @brief collection of hex rings sorted by ring for all given hexagons */
int H3LIBRARY_API H3_EXPORT(hexRanges)(H3Index *h3Set, int length, int k, H3Index *out);

/** @brief hexagon neighbors in all directions */
void H3LIBRARY_API H3_EXPORT(kRing)(H3Index origin, int k, H3Index *out);
/** @} */
 ...
 */
void H3LIBRARY_API H3_EXPORT(kRingDistances)(H3Index origin, int k, H3Index *out,
                               int *distances);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(hexRing)(H3Index origin, int k, H3Index *out);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(maxPolyfillSize)(const GeoPolygon *geoPolygon, int res);

/** @brief hexagons within the given geofence */
void H3LIBRARY_API H3_EXPORT(polyfill)(const GeoPolygon *geoPolygon, int res, H3Index *out);
/** @} */
...
void H3LIBRARY_API H3_EXPORT(h3SetToLinkedGeo)(const H3Index *h3Set, const int numHexes,
                                 LinkedGeoPolygon *out);

/** @brief Free all memory created for a LinkedGeoPolygon */
void H3LIBRARY_API H3_EXPORT(destroyLinkedPolygon)(LinkedGeoPolygon *polygon);
/** @} */
...
double H3LIBRARY_API H3_EXPORT(degsToRads)(double degrees);
/** @} */
...
double H3LIBRARY_API H3_EXPORT(radsToDegs)(double radians);
/** @} */
...
double H3LIBRARY_API H3_EXPORT(hexAreaKm2)(int res);

/** @brief hexagon area in square meters */
double H3LIBRARY_API H3_EXPORT(hexAreaM2)(int res);
/** @} */
...
double H3LIBRARY_API H3_EXPORT(edgeLengthKm)(int res);

/** @brief hexagon edge length in meters */
double H3LIBRARY_API H3_EXPORT(edgeLengthM)(int res);
/** @} */
...
int64_t H3LIBRARY_API H3_EXPORT(numHexagons)(int res);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(h3GetResolution)(H3Index h);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(h3GetBaseCell)(H3Index h);
/** @} */
...
H3Index H3LIBRARY_API H3_EXPORT(stringToH3)(const char *str);
/** @} */
...
void H3LIBRARY_API H3_EXPORT(h3ToString)(H3Index h, char *str, size_t sz);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(h3IsValid)(H3Index h);
/** @} */
 ...
 */
H3Index H3LIBRARY_API H3_EXPORT(h3ToParent)(H3Index h, int parentRes);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(maxH3ToChildrenSize)(H3Index h, int childRes);

/** @brief provides the children (or grandchildren, etc) of the given hexagon */
void H3LIBRARY_API H3_EXPORT(h3ToChildren)(H3Index h, int childRes, H3Index *children);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(compact)(const H3Index *h3Set, H3Index *compactedSet,
                       const int numHexes);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(maxUncompactSize)(const H3Index *compactedSet, const int numHexes,
                                const int res);

/** @brief uncompacts the compacted hexagon set */
int H3LIBRARY_API H3_EXPORT(uncompact)(const H3Index *compactedSet, const int numHexes,
...
int H3LIBRARY_API H3_EXPORT(h3IsResClassIII)(H3Index h);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(h3IsPentagon)(H3Index h);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(h3IndexesAreNeighbors)(H3Index origin, H3Index destination);
/** @} */
 ...
 * destination */
H3Index H3LIBRARY_API H3_EXPORT(getH3UnidirectionalEdge)(H3Index origin, H3Index destination);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(h3UnidirectionalEdgeIsValid)(H3Index edge);
/** @} */
 ...
 * H3Index */
H3Index H3LIBRARY_API H3_EXPORT(getOriginH3IndexFromUnidirectionalEdge)(H3Index edge);
/** @} */
 ...
 * H3Index */
H3Index H3LIBRARY_API H3_EXPORT(getDestinationH3IndexFromUnidirectionalEdge)(H3Index edge);
/** @} */
 ...
 * edge H3Index */
void H3LIBRARY_API H3_EXPORT(getH3IndexesFromUnidirectionalEdge)(H3Index edge,
 ...
 */
void H3LIBRARY_API H3_EXPORT(getH3UnidirectionalEdgesFromHexagon)(H3Index origin,
                                                    H3Index *edges);
/** @} */
...
void H3LIBRARY_API H3_EXPORT(getH3UnidirectionalEdgeBoundary)(H3Index edge, GeoBoundary *gb);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(h3Distance)(H3Index origin, H3Index h3);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(experimentalH3ToLocalIj)(H3Index origin, H3Index h3,
                                       CoordIJ *out);
/** @} */
...
int H3LIBRARY_API H3_EXPORT(experimentalLocalIjToH3)(H3Index origin, const CoordIJ *ij,
                                       H3Index *out);
/** @} */
